...
class AppStore extends Component {
  ...
  render() {
    ...
    const appItemdisplay = appsList.filter(
      eachApplistItems => eachApplistItems.category === activeTab,
    )
    const searchFilteredResult = appItemdisplay.filter(eachItem =>
